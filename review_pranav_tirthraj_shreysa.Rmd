...
6) HopReducer/Hopmapper code is extremely hard to understand because of no comments and no comments for what each methods do.
6) I could not get the code to run,even after following the steps outlined in the readme file.
