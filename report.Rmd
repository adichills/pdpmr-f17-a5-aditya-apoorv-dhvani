...
The program was run on AWS EMR with one namenode and four datanodes on the whole dataset. Below is the configuration of the machines used:
Namenode: 
...
The program ran on the EMR configuration mentioned above, within 29 minutes
