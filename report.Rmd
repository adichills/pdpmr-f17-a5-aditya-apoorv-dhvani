...
After the fourth step when we give the above data to our model for prediction and consider delay and cancellation for prediction, following was the result

| Correct Predicted Hops 	| Incorrect Predicted Hops 	|
|-------------	|-------------	  |
| 3263         	| 134        	    |
...
_total correct hops: the total number of two hop connections which were on time_
