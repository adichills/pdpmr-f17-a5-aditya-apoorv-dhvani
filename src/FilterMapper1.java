...
// this mapper reads the output from HopReducer which is list of tuples of first
// hop and second hop flights and outputs the below key and value:
// output key - month, day, origin, destination 
// output value - FirstHop/SecondHop, First hop flight, Second hop flight
