...
/*
    ...
    2) - Compute the delay and cancelled information by month ,airline ,origin and destination for all the years prior to
        the year in the input
    3) - Filter the hops (First flight and Second Flight pair where the first flight arrives late or is cancelled more than 20% of time historically
    4) - Filter the hops (First flight and Second Flight pair where the second flight is cancelled more than 20% of the times
         historically
    5) - Calculate the hops again with the actual arrival time and actual departure time for computing the Number of correct records
